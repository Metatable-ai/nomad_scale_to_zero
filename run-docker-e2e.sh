...
: "${E2E_ENABLE_ACTIVATOR_SERVICE:=true}"
: "${E2E_ACTIVATOR_BASE_URL:=http://activator:8090}"
...
export E2E_ENABLE_ACTIVATOR_SERVICE
export E2E_ACTIVATOR_BASE_URL
...
printf '  E2E_ENABLE_ACTIVATOR_SERVICE=%s\n' "$E2E_ENABLE_ACTIVATOR_SERVICE"
printf '  E2E_ACTIVATOR_BASE_URL=%s\n' "$E2E_ACTIVATOR_BASE_URL"
